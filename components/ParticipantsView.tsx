...
type ParticipantsViewProps = ReturnType<typeof usePIMSData> & { currentUserRole: UserRole };
...
export const ParticipantsView: React.FC<ParticipantsViewProps> = ({ participants, addParticipant, updateParticipant, deleteParticipant, currentUserRole }) => {
            ...
            {filteredParticipants.length > 0 ? filteredParticipants.map(p => (
              <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                    ...
                    {isSuperAdmin && <Button variant="danger" size="sm" onClick={() => handleDeleteRequest(p)}>Delete</Button>}
                </td>
              </tr>
            )) : (
              <tr>
