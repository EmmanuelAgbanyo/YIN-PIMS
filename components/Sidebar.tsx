...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, isOpen, setIsOpen, currentUserRole }) => {
    ...
    const navItems: NavItem[] = [
        { view: 'dashboard', label: 'Dashboard', icon: <DashboardIcon />, roles: ['Super Admin', 'Admin', 'Organizer', 'Club Executive', 'Volunteer Coordinator', 'Viewer'] },
        { view: 'participants', label: 'Participants', icon: <UsersIcon />, roles: ['Super Admin', 'Admin', 'Organizer', 'Club Executive', 'Volunteer Coordinator', 'Viewer'] },
        { view: 'events', label: 'Events', icon: <CalendarIcon />, roles: ['Super Admin', 'Admin', 'Organizer', 'Club Executive', 'Volunteer Coordinator', 'Viewer'] },
        { view: 'clubs', label: 'Clubs', icon: <CollectionIcon />, roles: ['Super Admin', 'Admin', 'Organizer', 'Club Executive', 'Viewer'] },
        { view: 'volunteers', label: 'Volunteers', icon: <HeartIcon />, roles: ['Super Admin', 'Admin', 'Volunteer Coordinator'] },
...
const CollectionIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 20 20" fill="currentColor"><path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1z" /></svg>;
...
const HeartIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" /></svg>;
